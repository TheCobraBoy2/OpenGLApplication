...
bool OverlayLayer::IsButtonHovered() const
{
  ...
  return normalizedMousePos.x > (-0.8f - 0.2604 * 0.5f) && normalizedMousePos.x < (-0.8f + 0.2604f * 0.5f) && normalizedMousePos.y > (-0.75f - 0.2222f * 0.5f) && normalizedMousePos.y < (-0.75f + 0.2222f * 0.5f);
}
